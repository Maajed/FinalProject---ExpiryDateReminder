...
public class DrinkCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String statement = "Categories/Drinks/" + currentUser;
...
//
                ...
                DrinkAdapter drinkAdapter = new DrinkAdapter(finalList, getApplicationContext());
...
//                DataClass dataClass = new DataClass(myList.get(1), myList.get(3), myList.get(0), myList.get(2), myList.get(4));
        ...
        Log.d("Drink", "finalList: " + finalList.toString());


        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DrinkCategory.this,DrinkUpload.class);
        ...
        nav_view.setOnItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if(item.getItemId()== R.id.home_btn){
                    intent = new Intent(DrinkCategory.this,Home.class);
                }
                else if(item.getItemId()== R.id.profile_btn){
                    intent = new Intent(DrinkCategory.this,Profile.class);
                }
            ...
            private void signOutUser() {
                Intent MainActivity = new Intent(DrinkCategory.this,MainActivity.class);
    ...
    private long daysCalculator(DataClass dataClass) {
        ...
        try {
            ...
            if (date != null) {
                ...
                Log.e("DrinkCategory", "Failed to parse date");
                return -1; // or any suitable default value
            }
        } catch (ParseException e) {
            // Handle the parsing exception
            Log.e("DrinkCategory", "ParseException: " + e.getMessage());
            return -1; // or any suitable default value
        }
