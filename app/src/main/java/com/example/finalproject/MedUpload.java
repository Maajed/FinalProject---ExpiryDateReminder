    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uploadDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                picker = new DatePickerDialog(MedUpload.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                StorageReference fileRef = storageRef
                        .child("medicine/" + System.currentTimeMillis() + "-" + uri.getLastPathSegment());
                UploadTask uploadTask = fileRef.putFile(uri);
                uploadTask.addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        // Handle unsuccessful uploads
                        Toast.makeText(MedUpload.this, "Upload failed: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                ...
                .setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            Toast.makeText(MedUpload.this, "Saved", Toast.LENGTH_SHORT).show();
//                            finish();
                        }
                    }
                    ...
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(MedUpload.this, e.getMessage().toString(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
