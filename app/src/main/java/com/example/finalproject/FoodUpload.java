        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    StorageReference fileRef = storageRef
                            .child("food/" + System.currentTimeMillis() + "-" + uri.getLastPathSegment());
                    UploadTask uploadTask = fileRef.putFile(uri);
                    uploadTask.addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            // Handle unsuccessful uploads
                            Toast.makeText(FoodUpload.this, "Upload failed: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                ...
                .setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            Toast.makeText(FoodUpload.this, "Saved", Toast.LENGTH_SHORT).show();
//                            finish();
                        }
                    }
