...
public class FoodCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String statement = "Categories/Food/" + currentUser;
...
//                    Log.e("Naim", "itemSnapShot: " + .getValue(String.class));
                ...
                FoodAdapter foodAdapter = new FoodAdapter(finalList, getApplicationContext());
...
//                DataClass dataClass = new DataClass(myList.get(1), myList.get(3), myList.get(0), myList.get(2), myList.get(4));
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(FoodCategory.this,FoodUpload.class);
        ...
        nav_view.setOnItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if(item.getItemId()== R.id.home_btn){
                    intent = new Intent(FoodCategory.this,Home.class);
                }
                else if(item.getItemId()== R.id.profile_btn){
                    intent = new Intent(FoodCategory.this,Profile.class);
                }
            ...
            private void signOutUser() {
                Intent MainActivity = new Intent(FoodCategory.this,MainActivity.class);
